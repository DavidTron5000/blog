...
The [JAMstack](https://jamstack.org/) is an ideal way of building websites and apps that are fast, secure and simple to work with. The "JAM" in JAMstack stands for JavaScript, APIs and Markup. This approach relinquishes the shackles of servers, host all your front-end on a CDN and use APIs for any moving parts.
